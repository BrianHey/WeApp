...
<script type="text/javascript" src="metodo-flujo-no-continuo.js"></script>
</head>
<body>
...
<br><center><h3 style="margin-left: 35%;"><b>Flujo no-continuo (van Everdingen-Hurst)</b></h3></center><br>
...
<div style=" width: 90%;  margin-left: 40%" id="tabla-formulario">	
			...
			<center><h4>Datos del acuífero</h4></center><br>
			   ...
			   <div class="form-row">
					...
					<div class="col">
						<div class="row">
							<div class="col-1 align-self-center"> <h5><i>P<sub></sub></i></h5> </div>
							<div class="col-9"><input id="pe" placeholder="presion del yacimiento" class="form-control" type="" name=""></div>
			...
			<center><h4>Datos del yacimiento</h4></center><br>
			   ...
			   <div class="form-row">
					...
					<div class="col-6">
						<div class="row">
							<div  class="col-1 align-self-center"> <h5><i>t</i></h5> </div>
							<div class="col-9"><input id="t" placeholder="tiempo" class="form-control generar-filas" type="" name=""></div> 
							</div>
					</div>
			   ...
			   <div class="form-row">
					...
					<div class="col-6">
						<div class="row">
							<div  class="col-1 align-self-center"> <h5><i>t<sub>a</sub></i></h5> </div>
							<div class="col-9">
								<select class="form-control" id="ta">
									<option value="unopuntocinco">1.5</option>
									<option value="dospuntocero">2.0</option>
									<option value="dospuntocinco">2.5</option>
									<option value="trespuntocero">3.0</option>
									<option value="trespuntocinco">3.5</option>
									<option value="cuatropuntocero">4.0</option>
									<option value="cuatropuntocinco">4.5</option>
									<option value="cincopuntocero">5.0</option>
									<option value="seispuntocero">6.0</option>
									<option value="sietepuntocero">7.0</option>
									<option value="ochopuntocero">8.0</option>
									<option value="nuevepuntocero">9.0</option>
									<option value="diezpuntocero">10.0</option>
								</select>
						</div> <div  class="col-1 align-self-center "><span  id="unidades"><i>pies</i></span></div> 
						</div>
					</div>
	...
	<div class="form-row justify-content-center botoness">
				...
				<div class="row justify-content-center butons">
					...
					<div class="col" ><button id="prueba">pruebaaaaa </button></div>
				</div>
	</div>
