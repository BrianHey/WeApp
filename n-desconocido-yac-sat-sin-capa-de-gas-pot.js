$(document).ready(function (){
	...
	$('.generar').click( function (){
			...
			for (var i = 1; i <= contador; i++) {
				...
				dpr[mi] = Number(dp[mi]).toLocaleString();
				dpeor[mi] = Number(dpeo[mi]).toLocaleString();
				...
				var result = ' <div class="row  resultados"><div class="col text-center"><h4><b>Resultados</b></h4></div></div><div class="row text-center"><div class="col-6"><br><b><i>N</i> petróleo original en sitio</b> <br>'+ br +' BN</div><div class="col-6"><br><b><i>C</i> constante de intrusión de agua</b> <br>'+ m2r +' BY/lpca·día</div></div>';
				$('#resultados').html(result);

					var filasRes = "";
					 
					var thead= '<thead><tr><th scope="col">N°</th><th scope="col">&Delta;P (lpca)</th><th scope="col"> F/E<sub>o</sub> (BN)</th><th scope="col"> &Delta;P/E<sub>o</sub> (lpca·día·BN/BY) </th><th scope="col">W<sub>e</sub> (BY)</th></tr></thead><tbody id="tbody"></tbody>'
					 $('.table-hover-resultados').html(thead);	


					 for (var o = 1; o <= contador; o++) 
					 {
					 	var filaRes = '<tr><th scope="row">'+ o + '</th><td>'+ dpr[o]+ '</td><td>'+ feor[o]+'</td><td>'+ dpeor[o] + '</td><td>'+ wer[o] +'</td></tr>';
