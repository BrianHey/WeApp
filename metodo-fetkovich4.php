...
<script type="text/javascript" src="metodo-fetkovich4.js"></script>
</head>
<body>
...
<br><center><h3 style="margin-left: 35%;"><b>Método Fetkovich: acuífero finito, presión constante, lineal</b></h3></center><br>
			...
			<br>
			  ...
			  <div class="form-row barra">
				...
				<div class="form-row barra">
					...
					<div class="col-6">
						<div class="row">
							<div class="col-1 align-self-center"><h5><i>L</i></h5></div>
							<div class="col-9"><input id="l" placeholder="longitud" class="form-control" type="" name=""></div>
							<div  class="col-2 align-self-center "><span  id="unidades"><i>pies</i></span></div> 
						</div>
					</div>
			   ...
			   <div class="col-6">
						<div class="row">
							<div class="col-1 align-self-center"><h5><i>w</i></h5></div>
							<div class="col-9"><input id="w" placeholder="ancho" class="form-control" type="" name=""></div>
							<div  class="col-2 align-self-center "><span  id="unidades"><i>pies</i></span></div> 
						</div>
					</div>
