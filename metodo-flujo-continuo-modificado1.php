...
<script type="text/javascript" src="metodo-flujo-continuo-modificado1.js"></script>
</head>
<body>
...
<br><center><h3 style="margin-left: 35%;"><b>Flujo continuo-modificado (Hurst): presión estabilizada</b></h3></center><br>
			   ...
			   <div class="form-row">
					...
					<div class="col-6">
						<div class="row">
							...
							<div class="col-9"><input " id="pe" placeholder="presión actual" class="form-control" type="" name=""></div> <div  class="col-1 align-self-center "><span  id="unidades"><i>lpca</i></span></div> 
						</div>
					</div>
