$(document).ready(function (){
	...
	$('.generar').click( function (){			
			...
			for (var i = 1; i <= contador; i++) {
					...
					np[i] = $('#cuerpo-tabla').find("#np"+i+""+(i+2)).val();
					bo[i] = $('#cuerpo-tabla').find("#bo"+i+""+(i+3)).val();
					co[i] = $('#cuerpo-tabla').find("#co"+i+""+(i+4)).val();
					so[i] = $('#cuerpo-tabla').find("#so"+i+""+(i+5)).val();
					wp[i] = $('#cuerpo-tabla').find("#wp"+i+""+(i+6)).val();
					bw[i] = $('#cuerpo-tabla').find("#bw"+i+""+(i+7)).val();
					wi[i] = $('#cuerpo-tabla').find("#wi"+i+""+(i+8)).val();
					cw[i] = $('#cuerpo-tabla').find("#cw"+i+""+(i+9)).val();
					cfe[i] = $('#cuerpo-tabla').find("#cfe"+i+""+(i+10)).val();
	...
	$(".generar-filas").change(function(){
		...
		contador = numfil;
...

		 {
			...
			var fila = '<tr><th scope="row">'+ i + '</th><td><input id="t'+i+""+i+'" class="form-control" name=""></td><td><input id="pe'+i+""+(i+1)+ '" class="form-control " name=""></td><td><input id="np'+i+""+(i+2)+ '" class="form-control " name=""></td><td><input  id="bo'+i+""+(i+3)+ '" class="form-control" name=""></td><td><input  id="co'+i+""+(i+4)+ '" class="form-control" name=""></td><td><input  id="so'+i+""+(i+5)+ '" class="form-control" name=""></td><td><input  id="wp'+i+""+(i+6)+ '" class="form-control" name=""></td><td><input  id="bw'+i+""+(i+7)+ '" class="form-control" name=""></td><td><input  id="wi'+i+""+(i+8)+ '" class="form-control" name=""></td><td><input  id="cw'+i+""+(i+9)+ '" class="form-control" name=""></td><td><input  id="cfe'+i+""+(i+10)+ '" class="form-control" name=""></td></tr>';
